...
if NOT DEFINED WORKSPACE set WORKSPACE=d:\Program Files (x86)\Jenkins\workspace\JerseyTrains
...
del /q "%WORKSPACE%\lambda_deploy\jerseytrains.zip"

:: Generate our deployment package
"%ZIP_PROG%" a -r "%WORKSPACE%\lambda_deploy\jerseytrains.zip" "%WORKSPACE%\lambda_deploy\*.*"
